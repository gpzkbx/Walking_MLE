...
[ExecuteInEditMode]
public class RenderRandomdotRight : MonoBehaviour {
    ...
    //change the seed of random dot
    public void SwitchRDSeed(float Seed)
    {
        random_dot_seed = Seed;
    }

    //change the seed of noise shift
    public void SwitchNSSeed()
    {
        noise_shift_seed = Random.Range(0, 100);
    }

    //change the seed of ran
    public void SwitchRSeed()
    {
        ran_seed = Random.Range(0, 100);
    }
    ...
    private void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        if (curShader != null)
        {
            ...
            ScreenMat.SetFloat("_NoiseShiftSeed", noise_shift_seed);
            ScreenMat.SetFloat("_RanSeed", ran_seed);
